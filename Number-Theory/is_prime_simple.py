...
def is_prime(number):
	"""Returns True if the argument number is prime"""

	if type(number).__name__ == 'int':
		pass
	elif type(number).__name__ == 'float' and (number).is_integer():
		pass
	else:
		return False
...
class Test(unittest.TestCase):
	primes = (2,10,17,101,601,877,911,99991,5915587277)
	non_primes = (2000,4,253,27,49,77,'hi',-19, 17.1,3)
